...
class Answers(models.Model):
    ...
    answer = models.BooleanField(blank=False, null=True)
...
class UserProfile(models.Model):
    ...
    is_admin = models.BooleanField(default=False)  # True for admin users
    created_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='participants')  # Admin who created this user
