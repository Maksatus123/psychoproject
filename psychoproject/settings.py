"""
Django settings for psychoproject project.
...
SECRET_KEY = 'django-insecure-30yrbphhhuc_6chf63f_)a85q6zio-fx@hda^e^r(k%+3=&x!_'
...
WSGI_APPLICATION = 'psychoproject.wsgi.application'
...
if os.getenv('RENDER', '').lower() == 'true':
    ...
    # Локальная конфигурация (для скриптов и разработки)
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': 'postgres',
